    ...
    <>
      <div className="h-[100vh] flex items-center justify-center " style={{background: "linear-gradient(90deg, #0199A7 0%, #B4DCDA 100%)"}}>
        <form className="flex-col flex px-[30px] w-[350px] py-[30px] xl:w-auto xl:px-[90px] xl:py-[45px] rounded-[18px]" style={{background:" linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), rgba(22, 47, 61, 0.6)"}}>
          <h5 className="text-center font-bold text-[20px] mb-[20px] xl:text-[35px] text-white xl:mb-[50px]">Sign Up</h5>
          <div className="xl:gap-x-5 flex-col xl:flex-row flex">
            <div className="flex flex-col">
              <p className="font-bold text-[12px] text-putih mb-[10px]">First Name</p>
              <input placeholder="Enter your first name" className="mb-[10px] bg-[#878FB533] xl:p-[10px] text-putih p-[5px] w-auto"></input>
            </div>
            <div className="flex flex-col">
              <p className="font-bold text-[12px] text-putih mb-[10px]">Last Name</p>
              <input placeholder="Enter your last name" className="bg-[#878FB533] xl:p-[10px] p-[5px] mb-[10px] text-putih"></input>
            </div>
          </div>
          ...
          <input placeholder="Enter your address" className="mb-[10px] bg-[#878FB533] p-[10px] text-putih" ></input>
          ...
          <p className="font-bold text-[12px] text-putih mb-[10px]">Confirm Password</p>
          <input placeholder="Enter your password" className="mb-[10px] bg-[#878FB533] p-[10px] text-putih"></input>
          <button className="rounded-none my-[20px] xl:my-[40px]">Sign Up</button>
          <a className="text-center text-[#83C5BE] text-[12px] xl:text-[15px]">Already have an account? <span className="text-putih">Login</span></a>
        </form>
      </div>
    </>
  );
